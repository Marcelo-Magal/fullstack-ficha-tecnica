...
app.listen(PORT, () => console.log(`Server running on http://localhost:${PORT}`)); // Inicia o servidor para escutar na porta definida. Quando o servidor começa a escutar, ele executa
